                ...
                <div class="col-md-12">
                    <div class="agent agent-page long-content">
                        ...
                        <div class="agent-content">
                            ...
                            <div style="font-size: 16px !important;">{ABOUT}</div>
                            ...
                            <div class="freelancer-socials margin-top-25">
                                <ul>
                                    IF("{FACEBOOK}"!=""){  <li><a href="{FACEBOOK}" target="_blank" class="facebook"><i class="la la-facebook"></i></a></li> {:IF}
                                    IF("{TWITTER}"!=""){  <li><a href="{TWITTER}" target="_blank" class="twitter"><i class="la la-twitter"></i></a></li>{:IF}
                                    IF("{GPLUS}"!=""){  <li><a href="{GPLUS}" target="_blank" class="google"><i class="la la-pinterest"></i></a></li>{:IF}
                                    IF("{LINKEDIN}"!=""){  <li><a href="{LINKEDIN}" target="_blank" class="linkden"><i class="la la-linkedin"></i></a></li>{:IF}
                                    IF("{INSTAGRAM}"!=""){  <li><a href="{INSTAGRAM}" target="_blank" class="instagram"><i class="la la-instagram"></i></a></li>{:IF}
                                    IF("{YOUTUBE}"!=""){  <li><a href="{YOUTUBE}" target="_blank" class="youtube"><i class="la la-youtube"></i></a></li>{:IF}
                                </ul>
                                <!--end social-->
                            </div>

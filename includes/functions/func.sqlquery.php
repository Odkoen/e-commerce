    ...
    foreach ($result as $info)
    {
        ...
        if($info['custom_type'] == 'radio-buttons')
        {
            ...
            foreach($options as $key3=>$value3)
            {
                ...
                if($config['tpl_name'] == 'modern-theme'){
                    $radiobtn .= '<div class="checkbox"><label><input type="radio" name="custom['.$info['custom_id'].']" value="'.$value3.'" data-name="'.$info['custom_id'].'" '.$checked.'> '.$option_title.' </div>';
                }
        ...
        if($info['custom_type'] == 'checkboxes')
        {
            ...
            foreach($options as $key4=>$value4)
            {
                ...
                if($config['tpl_name'] == 'classic-theme' || $config['tpl_name'] == 'material-theme'){
                    $Checkbox .= '
                ...
                else if($config['tpl_name'] == 'modern-theme'){
                    $Checkbox .= '<div class="checkbox"><label><input type="checkbox" name="custom['.$info['custom_id'].'][]" data-name="'.$info['custom_id'].'" value="'.$value4.'" '.$selected.'> '.$option_title.' </label></div>';
                }
                else if($config['tpl_name'] == 'thenext-theme'){
                    ...
                    $Checkbox .= '<div class="col-md-4 col-sm-4"><input class="with-gap" type="checkbox" name="custom['.$info['custom_id'].'][]" id="'.$value4.$j.'" value="'.$value4.'" data-name="'.$info['custom_id'].'" '.$selected.' />';

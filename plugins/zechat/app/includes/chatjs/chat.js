...
$(document).on('click', ".start_zechat" ,function(){
    ...
    var session_userid = $(this).data('session_userid');
    ...
    chatWith(username,userimage,userstatus)
});
...
function createChatBox(chatboxtitle,chatheaderimg,status,minimizeChatBox) {
    ...
    $("<div />" ).attr("id","chatbox_"+chatboxtitle)
        ...
        .html('<div class="chatbox-icon" onclick="javascript:toggleChatBoxGrowth(\''+chatboxtitle+'\')" href="#"><div class="contact-floating red"><img class="chat-image img-circle pull-left" src="'+siteurl+'storage/profile/small_'+chatheaderimg+'"><small class="unread-msg">2</small><small class="status"></small></div></div>' +
        '<div class="panel personal-chat"> ' +
        '<div class="panel-heading chatboxhead"> ' +
        '<div class="panel-title">' +
        '<img class="chat-image img-circle pull-left" height="36" width="36" src="'+siteurl+'storage/profile/small_'+chatheaderimg+'" alt="avatar-image"> ' +
